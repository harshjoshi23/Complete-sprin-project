...
public class ConnectionFactory {
	...
	public static Connection getMySqlConnection() {
		Connection con = null;
		// Driver manager is class with method called get connection that returns con(or conn we declared)
		// 
...
//			con = DriverManager.getConnection();
			...
			// ConnectionImplementation is class which implements the connection - by polymorphism
